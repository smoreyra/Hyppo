...
def load_data():
    try:
        ...
        df_bd_orders = pd.read_excel(r'C:\Users\solange.moreyra\Desktop\Sol\Solange-Moreyra-Repository\Hyppo\streamlit_app\bd_orders.xlsx', engine='openpyxl')

        # Base de datos de descargas de la app desde Diciembre 2022 en adelante
        df_BD_signups = pd.read_excel(r'C:\Users\solange.moreyra\Desktop\Sol\Solange-Moreyra-Repository\Hyppo\streamlit_app\BD_signups.xlsx', engine='openpyxl')
