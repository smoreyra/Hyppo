...
def load_data():
    try:
        ...
        df_BD_campaigns_Q3 = pd.read_excel('C:\Users\solange.moreyra\Desktop\Sol\Solange-Moreyra-Repository\Hyppo\streamlit_app\bd_campaigns_q3.xlsx', engine='openpyxl')
